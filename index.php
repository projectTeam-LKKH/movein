...
SELECT id, title, release_date, streaming
FROM movies
WHERE JSON_CONTAINS(genre, JSON_QUOTE('애니'))
AND release_date < '2025-11-07'
ORDER BY release_date DESC
LIMIT 10
";

$result = $connect->query($sql);
$hot_ani = $result->fetch_all(MYSQLI_ASSOC);
?>
  ...
  <body>
    ...
    <!-- 데이터에 해당되는 장르를 보여주는 구간 -->
     ...
     <section class="hot-container">
      <div class="hot-title">
        <div class="hot-txt-box">
          <h3 class="hot-txt">요즘 대세 드라마는?</h3>
          <img src="img/next_icon_6F6C76.png" alt="다음 버튼">
        </div>
        <div class="hot-wrap">
          <ul class="hot-nav-box">
            <li class="all-btn active">
                <p>All</p>
                <span class="point"></span>
            </li>
            <li class="all-btn">
              <img src="img/netflix.png" alt="보류"/>
                <span class="point"></span>
            </li>
            <li class="all-btn">
              <img src="img/watcha.png" alt="보류"/>
                <span class="point"></span>
            </li>
            <li class="all-btn">
              <img src="img/wavve.png" alt="보류"/>
                <span class="point"></span>
            </li>
            <li class="all-btn">
              <img src="img/TVING.png" alt="보류"/>
                <span class="point"></span>
            </li>
            <li class="all-btn">
              <img src="img/disney.png" alt="보류"/>
                <span class="point"></span>
            </li>
            <li class="all-btn">
              <img src="img/coupang.png" alt="보류"/>
                <span class="point"></span>
            </li>
            <li class="all-btn">
              <p>Other
        ...
        <div class="poster-wrap">
          <div class="poster-box">
            <ul class="all-posters">
                <li class="all-poster">
                  <a href="">
                    <img src="img/poster/pt002.webp" alt="hot-product">
                    <p class="poster-title">작품 제목이 들어갈 공간</p>
                  </a>
                  <div class="detail-box">
                    <div class="date-box">
                      <p>개봉일</p>
                      <span class="date-detail">0000.00.00</span>
                    </div>
                    <div class="score-contain">
                        <p class="score">별점</p>
                        <ul class="score-box">
